...
Before uploading files, you may need to log in to [MinIO](https://min.io/) console at [https://minio.local.dev/](https://minio.local.dev/) using `laravelapp` as both (username and password) and create a bucket named `laravelapp`.
